...
/// <summary>
/// Request to update organization intelligent routing policy settings.
/// </summary>
public sealed class UpdateRoutingPolicySettingsRequest
{
    ...
    public string FailoverStrategy { get; init; } = "RetryThenFailover";
