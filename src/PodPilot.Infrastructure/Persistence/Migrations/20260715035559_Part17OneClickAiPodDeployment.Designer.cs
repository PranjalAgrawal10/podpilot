...
namespace PodPilot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260715035559_Part17OneClickAiPodDeployment")]
    partial class Part17OneClickAiPodDeployment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.AiDeployment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<decimal>("EstimatedHourlyCostUsd")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<Guid?>("GatewayRouteId")
                        .HasColumnType("char(36)");

                    b.Property<string>("GpuCode")
                        .IsRequired()
                        .HasMaxLength(64)
                    ...
                    b.Property<string>("ProviderGpuId")
                        .IsRequired()
                        .HasMaxLength(200)
                    ...
                    b.ToTable("AiDeployments", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.BackupJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.DeploymentHealth", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool>("GatewayReachable")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("RuntimeRunning")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("StreamingWorks")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.ToTable("DeploymentHealthSnapshots", (string)null);
                });

            modelBuilder.Entity("PodPilot.Domain.Entities.DeploymentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("DeploymentHistoryEntries", (string)null);
                });

            modelBuilder.Entity("PodPilot.Domain.Entities.DeploymentLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.DeploymentModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid?>("ModelCatalogId")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("DeploymentModels", (string)null);
                });

            modelBuilder.Entity("PodPilot.Domain.Entities.DeploymentTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("DefaultModelCodesJson")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("varchar(2000)");
                    ...
                    b.Property<string>("RecommendedGpuCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.ToTable("DeploymentTemplates", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.GpuCatalogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("CudaCapability")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("varchar(32)");
                    ...
                    b.Property<string>("ProviderAvailabilityJson")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("varchar(1000)");
                    ...
                    b.ToTable("GpuCatalogEntries", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.ModelCatalogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<decimal>("DownloadSizeGb")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<string>("MinimumGpuCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.HasIndex("ModelReference");

                    b.ToTable("ModelCatalogEntries", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.OnboardingProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.OrganizationSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.PlanQuota", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<long>("MaxApiRequestsPerMonth")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.PlatformRelease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("PlatformReleases", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.ProductLicense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("ProductLicenses", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.RuntimeVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("Runtime", "Version")
                        .IsUnique();

                    b.ToTable("RuntimeVersions", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("RazorpayMonthlyPlanId")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");

                    b.Property<string>("RazorpayYearlyPlanId")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");

                    b.Property<decimal>("SeatPriceUsd")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.TelemetryPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool>("FeatureUsage")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("HealthReports")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("PerformanceMetrics")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.ToTable("TelemetryPreferences", (string)null);
                });
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.UsageRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("OrganizationId", "MetricKind", "PeriodStart");
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.AiDeployment", b =>
                {
                    ...
                    b.HasOne("PodPilot.Domain.Entities.DeploymentTemplate", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.DeploymentHealth", b =>
                {
                    b.HasOne("PodPilot.Domain.Entities.AiDeployment", "Deployment")
                        .WithOne("Health")
                        .HasForeignKey("PodPilot.Domain.Entities.DeploymentHealth", "DeploymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.DeploymentModel", b =>
                {
                    ...
                    b.HasOne("PodPilot.Domain.Entities.ModelCatalogEntry", "ModelCatalog")
                        .WithMany()
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.OrganizationSubscription", b =>
                {
                    ...
                    b.HasOne("PodPilot.Domain.Entities.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany()
            ...
            modelBuilder.Entity("PodPilot.Domain.Entities.PlanQuota", b =>
                {
                    b.HasOne("PodPilot.Domain.Entities.SubscriptionPlan", "SubscriptionPlan")
                        .WithOne("Quota")
                        .HasForeignKey("PodPilot.Domain.Entities.PlanQuota", "SubscriptionPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
